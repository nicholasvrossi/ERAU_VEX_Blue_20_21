...
#define MOTOR_FRONT_LEFT_PORT (8)
#define MOTOR_FRONT_RIGHT_PORT (5)
#define MOTOR_BACK_LEFT_PORT (6)
#define MOTOR_BACK_RIGHT_PORT (4)
#define MOTOR_LEFT_AIM (14)

// intake motors
#define MOTOR_INTAKE_LEFT_PORT  (20)
...
#define MOTOR_LAUNCHER_RIGHT_SHOOTER (20)
